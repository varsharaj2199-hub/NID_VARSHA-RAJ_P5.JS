...
function draw() {
  ...
  if (showDialogue) {
    ...
    if (dialogueStep === 0)
    text("Girl: Oh, what took you so long?...Click to continue.", width / 2, 50);
    else if (dialogueStep === 1)
      text("Boy: I was learning how to create lanterns for you.", width / 2, 50);
    else if (dialogueStep === 2)
      text("Girl: You are such a nerd.....Did you manage to complete it?", width / 2, 50);
    else if (dialogueStep === 3)
      text("Boy: Yess, let's watch!", width / 2, 50);
